...
public class ServerMain {
    ...
    public static void main(String[] args) {
        ...
        invoker.register(new RemoveKeyCommand(collectionManager, new InputReader(new Scanner(System.in))));
        ...
        // ... etc. (RemoveLower, ReplaceIfGreater, etc.)
    ...
    private static void handleClient(Socket socket, CommandInvoker invoker) {
        try (socket;
            ...
            ex.printStackTrace(); // <-- DEBUG. Print full stack trace
